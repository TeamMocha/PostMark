exports.handler = async (event) => {
  // Set the input of the function to the JSON we recieve in the POST
...
`;
  ...
  // Start our blank everythingTemplate
    ...
    // Since we won't know where (or if) the user has created a local version of the file
    // This code will be commented out unless there is a way to pass in the known filepath
    //
